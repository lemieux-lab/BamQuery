...
Computational pipeline attributing an RNA expression to any short peptide (8-11 aa), in any RNA-seq sample chosen by user.

BamQuery follows four important steps for every queried peptide:
