...
class BiotypeAssignation:
	...
	def get_biotypes(self, info_peptide_alignments, peptides_by_type):
		...
		# self.df2.to_pickle("/u/ruizma/BAM_Query/Scripts/EM/three_peptides/df2.pkl")
		# self.df3.to_pickle("/u/ruizma/BAM_Query/Scripts/EM/three_peptides/df3.pkl")
		# with open('/u/ruizma/BAM_Query/Scripts/EM/three_peptides/bam_files_list_rna.pkl', 'wb') as f:
		# 	pickle.dump(self.bam_files_list_rna, f)

		# with open('/u/ruizma/BAM_Query/Scripts/EM/three_peptides/order_sample_bam_files_rna.pkl', 'wb') as f:
		# 	pickle.dump(self.order_sample_bam_files_rna, f)

		# with open('/u/ruizma/BAM_Query/Scripts/EM/three_peptides/biotype_type.pkl', 'wb') as f:
	...
	def get_global_annotation(self):
		...
		#self.df_total_by_position_gen_ere.to_pickle("/u/ruizma/BAM_Query/Scripts/EM/all_peptides_dbSNP_14ss9_TCGA/df_total_by_position_gen_ere.pkl")
